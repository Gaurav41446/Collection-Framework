...
public class Assignment3Q9 {
    ...
    public static void main(String[] args) {
        SavingAccount account1 = new SavingAccount(10000, 101, "Rahul patel", true);
        SavingAccount account2 = new SavingAccount(15000, 104, "Aditya Gautam", false);
        SavingAccount account3 = new SavingAccount(24000, 102, "Nishant Yadav", true);
        SavingAccount account4 = new SavingAccount(30000, 103, "Gourav Singh", true);
