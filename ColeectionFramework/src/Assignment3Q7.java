...
public class Assignment3Q7 {
    ...
    public static void main(String[] args) {
        ...
        Assignment3Q7 obj1 = new Assignment3Q7("Gaurav ", "Fortuner", 101, 800289629, "Jamshedpur");
        Assignment3Q7 obj2 = new Assignment3Q7("Rahul", "Parado", 102, 938443929, "Patna");
        Assignment3Q7 obj3 = new Assignment3Q7("Nishant", "Hillux", 103, 527183934, "Dhanbad");
        Assignment3Q7 obj4 = new Assignment3Q7("Anand", "Thar", 104, 992339984, "Bihar");
        ...
        if(ownerList.parking.get(token1) != null) {
            Parked_CarOwnerDetails ownerDetails1 = ownerList.parkedCarOwnerDetails.get(ownerList.parking.get(token1).getCarNumber());
            System.out.println("\nCar owner details -> \nOwner Full Name: " + ownerDetails1.getOwnerName() + "\nOwner Car Model: "+
                    ownerDetails1.getCarModel() + "\nOwner Car Number: " + ownerDetails1.getCarNO() + "\nOwner Phone number: " +
                    ownerDetails1.getOwnerMobileNo() + "\nOwner Address: " + ownerDetails1.getOwnerAddress());
        }
        ...
        if(ownerList.parking.get(token2) != null) {
            Parked_CarOwnerDetails ownerDetails2 = ownerList.parkedCarOwnerDetails.get(ownerList.parking.get(token2).getCarNumber());
            System.out.println("\nCar owner details -> \nOwner Full Name: " + ownerDetails2.getOwnerName() + "\nOwner Car Model: "+
                    ownerDetails2.getCarModel() + "\nOwner Car Number: " + ownerDetails2.getCarNO() + "\nOwner Phone number: " +
                    ownerDetails2.getOwnerMobileNo() + "\nOwner Address: " + ownerDetails2.getOwnerAddress());
        }
    }
